...
output_file = "all/privacy_detection.xlsx"  # 输出文件名稍作修改
...
output_col_names = [
    ...
    "Private_gemma3",
    "Private_mistral",
    "Private_llama3.2:1b",   # 新增
    "Private_qwen2.5:3b"      # 新增
]
...
# 控制要处理的行数，这里取前 5 行或者较小者（可以根据需要修改）
...
# ------------------------------------------------------------------------------
# 5) 保存更新后的 DataFrame 到新的 Excel 文件
# ------------------------------------------------------------------------------
df.to_excel(output_file, index=False)

# 输出统计信息
print(f"\n共处理前 {rows_to_process} 行数据。")
